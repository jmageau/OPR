...
class LeasesControllerTest < ActionController::TestCase
  ...
  test "should create lease" do
    assert_difference('Lease.count') do
      post :create, lease: { customer_id: @lease.customer_id, duration: @lease.duration, monthly_fee: @lease.monthly_fee, property_id: @lease.property_id }
    end
  ...
  test "should update lease" do
    put :update, id: @lease, lease: { customer_id: @lease.customer_id, duration: @lease.duration, monthly_fee: @lease.monthly_fee, property_id: @lease.property_id }
    assert_redirected_to lease_path(assigns(:lease))
  end
