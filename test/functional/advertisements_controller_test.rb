...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { cost: @advertisement.cost, end_date: @advertisement.end_date, newspaper_name: @advertisement.newspaper_name, start_date: @advertisement.start_date }
    end
  ...
  test "should update advertisement" do
    put :update, id: @advertisement, advertisement: { cost: @advertisement.cost, end_date: @advertisement.end_date, newspaper_name: @advertisement.newspaper_name, start_date: @advertisement.start_date }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
